...
from data.dataloader.miniimagenet.autoaugment import AutoAugImageNetPolicy


class MiniImageNet(Dataset):

    def __init__(self, root='/home/miil/Datasets/FSCIL-CEC', train=True, transform=None,
